...
# 提前下载好的阉割版
# tokenizer = T5Tokenizer.from_pretrained(path_prot_t5_base_mt_uniref50, do_lower_case=False)  #
# model = T5EncoderModel.from_pretrained(path_prot_t5_base_mt_uniref50)
